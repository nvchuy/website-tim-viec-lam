...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th8 13, 2023 lúc 10:57 AM
...
CREATE TABLE `company` (
  ...
  `img_comp` varchar(50) NOT NULL,
  `address_comp` text NOT NULL,
  `info_comp` text NOT NULL,
  `website_comp` text NOT NULL,
  `email_comp` text NOT NULL,
  `pass_comp` text NOT NULL
...
CREATE TABLE `job` (
  ...
  `ID_comp` int(11) NOT NULL,
  `name_comp` text NOT NULL,
  `info_job` text NOT NULL,
  `require_job` text NOT NULL,
